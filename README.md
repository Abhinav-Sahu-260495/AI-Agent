...
Okay. Okay, no, I have a very simple task for you, okay? I needed to go into the code base We have a lot of redundant code right now. Okay. I'm really APIs.  We have code that has been duplicated multiple times because we've changed our architecture a couple of times. And things like that. I wanted to go through the entire code base and tell me which parts of the code are redundant, which parts are not, in the same way, along with the code, I wanted to see the database itself.  We have a lot of experimented tables and regular tables. So I want you to understand which tables are not needed, which tables are being used in the code right now. Okay.  Give me a list of all of this information. So we can start working on cleaning this up. Okay.
